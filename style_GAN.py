...
#
# The code base is based on HW3
#
# Usage:
# ======
#   To train with pertrained, make sure to have this run first to have a trained style identifier:
...
#
#   To train with clip:
#   python style_GAN.py --iden clip --checkpoint_dir checkpoints_stylegan_clip
